    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
          <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
            <div class="p-4 m-3">
              <img src="../assets/img/company.png" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
              <h4 class="text-dark font-weight-normal">Welcome <span class="font-weight-bold">FARMAGITECHS</span></h4>
              <p class="text-muted">Silahkan login terlebih dahulu untuk memulai explore aplikasi HRIS</p>
              <form action="{{url('handleLogin')}}" method="POST" id="loginForm">
                ...
                <div class="mt-5 text-center">
                    Belum memiliki akun ? <a href="auth-register.html">Buat baru</a>
                </div>
              </form>

              <div class="text-center mt-5 text-small">
                Copyright &copy; Cleanmaks. Made with 💙 by Stisla
              </div>
            </div>
          </div>
          <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="../assets/img/unsplash/login-bg.jpg">
            <div class="absolute-bottom-left index-2">
              <div class="text-light p-5 pb-2">
                <div class="mb-5 pb-3">
                  <h1 class="mb-2 display-4 font-weight-bold">Sugeng Rawuh</h1>
