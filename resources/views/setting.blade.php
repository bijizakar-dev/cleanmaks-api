            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-pills flex-column">
                                <li class="nav-item"><a href="{{route('setting.index')}}" class="nav-link active">General</a></li>
                                <li class="nav-item"><a href="{{route('setting.working-day')}}" class="nav-link">Jam Kerja</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="card" id="settings-card">
                        ...
                        <form method="POST" action="{{ route('setting.setting-update') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
