...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="{{ url('/jabatan')}}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Edit Jabatan</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ url('/')}}">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="{{ url('/jabatan')}}">Jabatan</a></div>
                        ...
                        <form method="POST" action="{{ route('jabatan.update', $jabatan->id) }}">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{$jabatan->name}}">
                                    @error('name')
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <select class="form-control selectric @error('status') is-invalid @enderror" name="status" value="{{$jabatan->status}}" required>
