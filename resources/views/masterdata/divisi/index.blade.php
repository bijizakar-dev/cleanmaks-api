            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>
                            <a href="{{ route('divisi.create') }}" class="btn btn-primary" ><i class="fas fa-plus"></i> Tambah</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href={{ url('divisi/edit/'.$val->id) }} class="btn btn-success btn-sm"><i class="fas fa-pencil-alt   "></i></a>
                                    <a href={{ url('divisi/delete/'.$val->id) }} class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            {{-- Panggil data divisi --}}
